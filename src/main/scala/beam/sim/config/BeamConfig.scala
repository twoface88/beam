// generated by tscfg 0.9.4 on Sat Oct 20 11:07:42 PDT 2018
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Outputs(
      ...
      agentsim                      : BeamConfig.Beam.Outputs.Agentsim,
      baseOutputDirectory           : java.lang.String,
      events                        : BeamConfig.Beam.Outputs.Events,
      physsim                       : BeamConfig.Beam.Outputs.Physsim,
    ...
    object Outputs {
      ...
      object Agentsim {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Agentsim = {
          BeamConfig.Beam.Outputs.Agentsim(
      ...
      object Physsim {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Physsim = {
          BeamConfig.Beam.Outputs.Physsim(
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          agentsim                      = BeamConfig.Beam.Outputs.Agentsim(if(c.hasPathOrNull("agentsim")) c.getConfig("agentsim") else com.typesafe.config.ConfigFactory.parseString("agentsim{}")),
          ...
          physsim                       = BeamConfig.Beam.Outputs.Physsim(if(c.hasPathOrNull("physsim")) c.getConfig("physsim") else com.typesafe.config.ConfigFactory.parseString("physsim{}")),
