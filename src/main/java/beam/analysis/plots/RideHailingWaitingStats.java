...
public class RideHailingWaitingStats implements IGraphStats {
    ...
    private final IStatComputation<Tuple<List<Double>, Map<Integer, List<Double>>>, Map<Integer, Map<Double, Integer>>> computation;
    ...
    public static class WaitingStatsComputation implements IStatComputation<Tuple<List<Double>, Map<Integer, List<Double>>>, Map<Integer, Map<Double, Integer>>> {

        @Override
        public Map<Integer, Map<Double, Integer>> compute(Tuple<List<Double>, Map<Integer, List<Double>>> stat) {
         ...
         */
        private Map<Integer, Map<Double, Integer>>
    ...
    public RideHailingWaitingStats(IStatComputation<Tuple<List<Double>, Map<Integer, List<Double>>>,
            Map<Integer, Map<Double, Integer>>> computation) {
    ...
    public void createGraph(IterationEndsEvent event) throws IOException {
        ...
        Map<Integer, Map<Double, Integer>> hourModeFrequency = computation.compute(new Tuple<>(getCategories(), hoursTimesMap));
    ...
    private CategoryDataset buildModesFrequencyDatasetForGraph(Map<Integer, Map<Double, Integer>> hourModeFrequency) {
        ...
        double[][] dataset = buildModesFrequencyDataset(hourModeFrequency, getCategories());
        if (dataset != null)
