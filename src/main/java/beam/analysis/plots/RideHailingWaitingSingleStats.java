...
public class RideHailingWaitingSingleStats implements IGraphStats {
    ...
    private final IStatComputation<Map<Integer, Double>, double[][]> computation;
    ...
    public static class SingleStatsComputation implements IStatComputation<Map<Integer, Double>, double[][]> {
    ...
    public RideHailingWaitingSingleStats(BeamServices beamServices, IStatComputation<Map<Integer, Double>, double[][]> computation) {
    ...
    public void createGraph(IterationEndsEvent event) throws IOException {
        ...
        double[][] data = computation.compute(hoursTimesMap);
