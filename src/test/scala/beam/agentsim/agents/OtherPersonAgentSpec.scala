  ...
  describe("A PersonAgent FSM") {
    ...
    it("should also work when the first bus is late") {
      ...
      scheduler ! ScheduleTrigger(NotifyLegStartTrigger(29400, busLeg2.beamLeg),
                                  personActor)
      scheduler ! ScheduleTrigger(NotifyLegEndTrigger(34400, busLeg2.beamLeg),
                                  personActor)
      expectMsgType[PersonEntersVehicleEvent]
      ...
      lastSender ! ReservationResponse(reservationRequestLateTram.requestId,
      ...
      scheduler ! ScheduleTrigger(
        NotifyLegStartTrigger(35000, replannedTramLeg.beamLeg),
        personActor)
      scheduler ! ScheduleTrigger(NotifyLegEndTrigger(40000,
