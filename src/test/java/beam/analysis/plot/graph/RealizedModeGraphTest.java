...
public class RealizedModeGraphTest {
    ...
    public void testShouldPassShouldReturnModeChoseEventOccurrenceForCRCUnitHour() {
        ...
        System.out.println(("actual walk test 1-  "+actaulWalkResult));
        System.out.println("actual car test 1-  " + actaulCarResult);
        System.out.println("actual ride_hail test 1- " + actaulRideHailResult);
        System.out.println("actal others test 1- " + actaulOtherResult);
    ...
    public void testShouldPassShouldReturnModeChoseEventOccurrenceForCRCRCUnitHour() {
        ...
        System.out.println("actual walk test 2- "+actaulWalkResult);
        System.out.println("actual car test 2- " + actaulCarResult);
        System.out.println("actual ride_hail test 2- " + actaulRideHailResult);
        System.out.println("actal others test 2- " + actaulOtherResult);
    ...
    public void testShouldPassShouldReturnModeChoseEventOccurrenceForNestedCRCRCUnitHour() {
        ...
        System.out.println("actual walk test 3- "+actaulWalkResult);
        System.out.println("actual car test 3-  " + actaulCarResult);
        System.out.println("actual ride_hail test 3- " + actaulRideHailResult);
        System.out.println("actal others test 3- " + actaulOtherResult);
        assertEquals(expectedWalkResult,actaulWalkResult );
        assertEquals(expectedCarResult,actaulCarResult );
        assertEquals(expectedRideHailResult,actaulRideHailResult );
        assertEquals(expectedOtherResult,actaulOtherResult);
    ...
    public void testShouldPassShouldReturnModeChoseEventOccurrenceForCRCForDifferentHoursTypeA() {
        ...
        System.out.println("actual walk test 4- "+actaulWalkResult);
        System.out.println("actual car test 4-  " + actaulCarResult);
        System.out.println("actual ride_hail test 4- " + actaulRideHailResult);
        System.out.println("actal others test 4-  " + actaulOtherResult);
    ...
    public void testShouldPassShouldReturnModeChoseEventOccurrenceForCRCForDifferentHoursTypeB() {
        ...
        System.out.println("actual walk test 5- "+actaulWalkResult);
        System.out.println("actual car test 5-  " + actaulCarResult);
        System.out.println("actual ride_hail test 5- " + actaulRideHailResult);
        System.out.println("actal others test 5- " + actaulOtherResult);
